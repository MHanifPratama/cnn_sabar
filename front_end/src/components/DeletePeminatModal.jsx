...
const DeletePeminatModal = ({ showDeleteModal, setShowDeleteModal, id, setUserData, userData }) => {
    const deleteDataEntry = async () => {
        try {
          const token = sessionStorage.getItem('token');
          const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/peminat/${id}`, {
            method: 'DELETE',
            headers: {
...
export default DeletePeminatModal