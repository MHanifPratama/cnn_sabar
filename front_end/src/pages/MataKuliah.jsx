                ...
                <div className="m-auto ml-7 overflow-x-auto overflow-y-auto" style={{ height: "78%", width: "95%"}}>
                    <Table hoverable style={{ width: '100%', borderCollapse: 'collapse' }}>
                        <Table.Head className="sticky top-0 z-10 bg-cyan-600">
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '10%' }}>Subjek</Table.HeadCell>
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '10%' }}>SKS</Table.HeadCell>
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '10%' }}>Kelas</Table.HeadCell>
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '10%' }}>Periode</Table.HeadCell>
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '10%' }}>Ruangan</Table.HeadCell>
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '17.5%' }}>Jadwal Mulai</Table.HeadCell>
                            <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: '17.5%' }}>Jadwal Selesai</Table.HeadCell>
                        ...
                        {userData && userData.filter((data) => {
                            ...
                            return search.toLowerCase() === '' ? data : data.title.toLowerCase().includes(search);
                                ...
                                <Table.Row key={data.id} className="bg-white dark:border-gray-700 dark:bg-gray-800">
                                    <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white" style={{ width: '10%' }}>
                                        {data.title}
                                    </Table.Cell>
                                    <Table.Cell className="whitespace-nowrap font-medium text-gray-900 dark:text-white" style={{ width: '10%' }}>
                                        {data.sks}
                                    ...
                                    <Table.Cell style={{ width: '17.5%' }}>{new Date(data.jadwal_mulai).toLocaleString('ID', options)}</Table.Cell>
                                    <Table.Cell style={{ width: '17.5%' }}>{new Date(data.jadwal_selesai).toLocaleString('ID', options)}</Table.Cell>
