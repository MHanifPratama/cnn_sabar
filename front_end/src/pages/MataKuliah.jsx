                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-6">
                        ...
                        <div>
                           ...
                           <TextInput id="jadwalMulai" placeholder="Jadwal Mulai" onChange={(event) => setJadwalMulai(event.target.value)} required />
                        </div>
                        <div>
                           <Label className="mb-2 block" htmlFor="jadwalSelesai" value="Jadwal Selesai" />
                           <TextInput id="jadwalSelesai" placeholder="Jadwal Selesai" onChange={(event) => setJadwalSelesai(event.target.value)} required />
                        </div>
                        <div>
                        ...
                        <Button
                           disabled={!title || !sks || !jadwalMulai || !selectedPeriode || !selectedKelas || !selectedRuangan}
                           onClick={() => {
                              setShowAddModal(false);
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-4">
                        ...
                        <div>
                           ...
                           <TextInput id="edit-jadwalMulai" placeholder="Jadwal" onChange={(event) => setJadwalMulai(event.target.value)} required />
                        </div>
                        <div>
                           <Label className="mb-2 block" htmlFor="jadwalSelesai" value="Jadwal Selesai" />
                           <TextInput id="jadwalSelesai" placeholder="Jadwal Selesai" onChange={(event) => setJadwalSelesai(event.target.value)} required />
            ...
            <div className="m-auto ml-7 overflow-x-auto overflow-y-auto" style={{ height: "78%", width: "95%" }}>
               <Table hoverable style={{ width: "100%", borderCollapse: "collapse" }}>
                  <Table.Head className="sticky top-0 z-10 bg-cyan-600">
                     <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: "15%" }}>
                        Subjek
                     </Table.HeadCell>
                     <Table.HeadCell className="dark:bg-cyan-600 bg-cyan-600 text-white" style={{ width: "15%" }}>
                        SKS
