                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-6">
                        ...
                        <div>
                           ...
                           <TextInput id="jadwal" placeholder="Jadwal" onChange={(event) => setJadwal(event.target.value)} required />
                        </div>
                        <div>
                        ...
                        <Button
                           disabled={!title || !sks || !jadwal || !selectedPeriode || !selectedKelas || !selectedRuangan}
                           onClick={() => {
                              setShowAddModal(false);
                  ...
                  <div className="space-y-6">
                     ...
                     <div className="space-y-4">
                        ...
                        <div>
                           ...
                           <TextInput id="edit-jadwal" placeholder="Jadwal" onChange={(event) => setJadwal(event.target.value)} required />
                        </div>
                        <div>
